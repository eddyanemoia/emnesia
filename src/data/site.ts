...
export const site = {
  ...
  currently: {
    ...
    entries: [
      { label: 'PLAYING', value: 'Pokemon HeartGold', image: '/images/heartgold-large.jpg', imageAlt: 'Pokemon HeartGold', },
      { label: 'WATCHING', value: 'Jerma VODs from 2021-2024', image: null, imageAlt: null },
      { label: 'READING', value: 'replace me', image: null, imageAlt: null },
      { label: 'USING', value: 'replace me', image: null, imageAlt: null },
      { label: 'THINKING ABOUT', value: 'replace me', image: null, imageAlt: null },
    ],
